        ...
        public static void Write(string p_strPath, Schedule sch, string elapsed, Dictionary<int, double> generationFitness, double[] finalScores, Context context)
        {
            using (ExcelPackage xlPackage_new = new ExcelPackage())
            {
                ...
                foreach (FinalExam exam in sch.FinalExams)
                {
                    ...
                    double studentScore = sch.Details[i - 2].StudentScore;
                    if (studentScore > 0)
                    {
                        ws_scheduling.Cells[i, 1].AddComment(sch.Details[i - 2].StudentComment, author);
                    ...
                    double supervisorScore = sch.Details[i - 2].SupervisorScore;
                    if (supervisorScore > 0)
                    {
                        ws_scheduling.Cells[i, 2].AddComment(sch.Details[i - 2].SupervisorComment, author);
                    ...
                    double presidentScore = sch.Details[i - 2].PresidentScore;
                    if (presidentScore > 0)
                    {
                        ws_scheduling.Cells[i, 3].AddComment(sch.Details[i - 2].PresidentComment, author);
                    ...
                    double secretaryScore = sch.Details[i - 2].SecretaryScore;
                    if (secretaryScore > 0)
                    {
                        ws_scheduling.Cells[i, 4].AddComment(sch.Details[i - 2].SecretaryComment, author);
                    ...
                    double memberScore = sch.Details[i - 2].MemberScore;
                    if (memberScore > 0)
                    {
                        ws_scheduling.Cells[i, 5].AddComment(sch.Details[i - 2].MemberComment, author);
                    ...
                    double examinerScore = sch.Details[i - 2].ExaminerScore;
                    if (examinerScore > 0)
                    {
                        ws_scheduling.Cells[i, 6].AddComment(sch.Details[i - 2].ExaminerComment, author);
                    ...
                    ws_scheduling.Cells[i, 8].Value = i - 2;
