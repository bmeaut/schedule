...
{
    public class SchedulingUniformCrossover : CrossoverBase
    {
        public SchedulingUniformCrossover(float mixProbability) : base(2, 2)
        {
            MixProbability = mixProbability;
        }

        public SchedulingUniformCrossover() : this(0.5f)
        {
        }
